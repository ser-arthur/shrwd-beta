...
export default function BetaPortalLogin() {
  ...
  return (
      <main className="flex min-h-[100dvh] flex-col items-center justify-center pb-20 sm:pb-0 p-4 sm:p-6 bg-shrwd-bg relative overflow-hidden">

        <div className="w-full max-w-[400px] flex flex-col mt-12 sm:mt-0 opacity-0 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
